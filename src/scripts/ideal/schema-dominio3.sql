...
insert into base_calculo (codigo, nombre, descripcion) values
  ...
  ('no_remunerativo_previo', 'No remunerativo previo (conc. 411 a 413)', 'Suma de las sumas no remunerativas cargadas antes del concepto que se calcula (411 + 412 + 413). Es la base de la antigüedad no remunerativa: el acuerdo la liquida sobre las sumas del propio acuerdo, no sobre el básico. Ex sub411_414 de SOS leído durante el concepto 414.'),
