...
function RouteComponent() {
  ...
  const isProfileRoute = pathParts.length >= 3 && pathParts[0] === 'clients' && pathParts[2] !== undefined && pathParts[2] !== '';
  
  console.log("[ClientRoute] pathname:", pathname, "pathParts:", pathParts, "isProfileRoute:", isProfileRoute, "clientId:", clientId);
