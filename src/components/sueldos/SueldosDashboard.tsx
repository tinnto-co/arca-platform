        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {loadingLiq
                ? '—'
                : `$${totalBruto.toLocaleString('es-AR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
            </div>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {loadingLiq
                ? '—'
                : `$${totalNeto.toLocaleString('es-AR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
            </div>
          </CardContent>
        </Card>
      </div>
