      ...
      <div className="px-5 pb-5 flex flex-col gap-3.5">
        ...
        <div className="flex items-center gap-2 flex-wrap pt-1">
          ...
          <button
            ...
            className="ml-auto h-[32px] px-3.5 rounded-[10px] text-[12.5px] font-semibold bg-[var(--arca-accent)] text-white inline-flex items-center gap-1.5 whitespace-nowrap hover:bg-[var(--arca-accent-hover)] transition-colors duration-120 motion-reduce:transition-none cursor-pointer"
          >
