...
export const asientoOrigenTipo = pgEnum("asiento_origen_tipo", ['manual', 'comprobante', 'recibo', 'movimiento_bancario', 'cierre', 'apertura', 'import'])
...
export const cuentaNaturalezaInflacion = pgEnum("cuenta_naturaleza_inflacion", ['monetaria', 'no_monetaria'])
...
export const jobType = pgEnum("job_type", ['iva', 'comprobantes', 'comprobantes_full', 'notificaciones', 'deuda', 'vencimientos', 'batch'])
...
export const reciboTipo = pgEnum("recibo_tipo", ['mensual', 'quincenal', 'sac', 'liquidacion_final', 'vacaciones'])
...
export const comprobante = pgTable("comprobante", {
	...
	index("idx_comprobante_cliente_periodo").using("btree", table.clienteId.asc().nullsLast().op("date_ops"), table.periodo.asc().nullsLast().op("date_ops")),
...
export const asiento = pgTable("asiento", {
	...
	index("idx_asiento_cliente_fecha").using("btree", table.clienteId.asc().nullsLast().op("date_ops"), table.fecha.asc().nullsLast().op("uuid_ops")),
	index("idx_asiento_origen").using("btree", table.origenTipo.asc().nullsLast().op("enum_ops"), table.origenId.asc().nullsLast().op("uuid_ops")),
