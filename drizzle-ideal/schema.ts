...
export const ajusteInflacion = pgTable("ajuste_inflacion", {
	...
	aplicadoAt: timestamp("aplicado_at", { withTimezone: true, mode: 'string' }),
...
export const cierreSueldos = pgTable("cierre_sueldos", {
	...
	cerradoAt: timestamp("cerrado_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	cerradoPor: text("cerrado_por"),
	reabiertoAt: timestamp("reabierto_at", { withTimezone: true, mode: 'string' }),
...
export const recibo = pgTable("recibo", {
	...
	calculadoAt: timestamp("calculado_at", { withTimezone: true, mode: 'string' }),
...
export const deuda = pgTable("deuda", {
	...
	detectadaAt: timestamp("detectada_at", { withTimezone: true, mode: 'string' }),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
...
export const proyeccionImpuesto = pgTable("proyeccion_impuesto", {
	...
	confianza: confianza(),
	factores: jsonb(),
	generadaAt: timestamp("generada_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
...
export const credencialAfip = pgTable("credencial_afip", {
	...
	ultimoLoginOk: timestamp("ultimo_login_ok", { withTimezone: true, mode: 'string' }),
	verificadaAt: timestamp("verificada_at", { withTimezone: true, mode: 'string' }),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
...
export const notificacion = pgTable("notificacion", {
	...
	publicadaAt: timestamp("publicada_at", { withTimezone: true, mode: 'string' }),
	...
	aiClasificadaAt: timestamp("ai_clasificada_at", { withTimezone: true, mode: 'string' }),
...
export const tareaPaso = pgTable("tarea_paso", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	tareaId: uuid("tarea_id").notNull(),
	titulo: text().notNull(),
	...
	index("ix_tarea_paso_tarea").using("btree", table.tareaId.asc().nullsLast().op("text_ops"), table.posicion.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.tareaId],
			foreignColumns: [tarea.id],
			name: "tarea_paso_tarea_id_fkey"
		}).onDelete("cascade"),
	foreignKey({
			columns: [table.completadoPor],
			foreignColumns: [user.id],
			name: "tarea_paso_completado_por_fkey"
		}).onDelete("set null"),
	pgPolicy("tenant", { as: "permissive", for: "all", to: ["arca_agent", "arca_app"], using: sql`(EXISTS ( SELECT 1
   FROM tarea t
  WHERE ((t.id = tarea_paso.tarea_id) AND (t.org_id = current_setting('app.org_id'::text, true)))))` }),
]);
...
export const agentAction = pgTable("agent_action", {
	...
	decididoAt: timestamp("decidido_at", { withTimezone: true, mode: 'string' }),
	ejecutadoAt: timestamp("ejecutado_at", { withTimezone: true, mode: 'string' }),
	error: text(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
...
export const cctFuente = pgTable("cct_fuente", {
	...
	activo: boolean().default(true).notNull(),
	ultimoOkAt: timestamp("ultimo_ok_at", { withTimezone: true, mode: 'string' }),
	ultimoError: text("ultimo_error"),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	ultimoIntentoAt: timestamp("ultimo_intento_at", { withTimezone: true, mode: 'string' }),
}, (table) => [
	foreignKey({
...
export const contraparte = pgTable("contraparte", {
	...
	provinciaActualizadaAt: timestamp("provincia_actualizada_at", { withTimezone: true, mode: 'string' }),
	direccion: text(),
...
export const lsdPresentacion = pgTable("lsd_presentacion", {
	...
	contenido: text().notNull(),
	generadoAt: timestamp("generado_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
...
export const member = pgTable("member", {
	...
	index("idx_member_org").using("btree", table.organizationId.asc().nullsLast().op("text_ops")),
	index("idx_member_user").using("btree", table.userId.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const solicitud = pgTable("solicitud", {
	...
	venceAt: timestamp("vence_at", { withTimezone: true, mode: 'string' }),
	completadaAt: timestamp("completada_at", { withTimezone: true, mode: 'string' }),
	detalle: jsonb(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
...
export const eecc = pgTable("eecc", {
	...
	pdfGeneradoAt: timestamp("pdf_generado_at", { withTimezone: true, mode: 'string' }),
...
export const invitation = pgTable("invitation", {
	...
	index("idx_invitation_inviter").using("btree", table.inviterId.asc().nullsLast().op("text_ops")),
	index("idx_invitation_org").using("btree", table.organizationId.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const tarea = pgTable("tarea", {
	...
	index("ix_tarea_columna_posicion").using("btree", table.columnaId.asc().nullsLast().op("text_ops"), table.posicion.asc().nullsLast().op("uuid_ops")),
	index("ix_tarea_estado").using("btree", table.orgId.asc().nullsLast().op("enum_ops"), table.estado.asc().nullsLast().op("text_ops")),
...
export const tareaCliente = pgTable("tarea_cliente", {
	...
	foreignKey({
			...
			name: "tarea_cliente_vencimiento_id_fkey"
		}).onDelete("set null"),
	pgPolicy("tenant", { as: "permissive", for: "all", to: ["arca_agent", "arca_app"], using: sql`(EXISTS ( SELECT 1
   FROM tarea t
...
export const tareaNotificacion = pgTable("tarea_notificacion", {
	...
	index("ix_tarea_notificacion_notificacion").using("btree", table.notificacionId.asc().nullsLast().op("uuid_ops")),
	uniqueIndex("uq_tarea_notificacion").using("btree", table.tareaId.asc().nullsLast().op("uuid_ops"), table.notificacionId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.tareaId],
			foreignColumns: [tarea.id],
			name: "tarea_notificacion_tarea_id_fkey"
		}).onDelete("cascade"),
	foreignKey({
			columns: [table.notificacionId],
			foreignColumns: [notificacion.id],
			name: "tarea_notificacion_notificacion_id_fkey"
		}).onDelete("cascade"),
	pgPolicy("tenant", { as: "permissive", for: "all", to: ["arca_agent", "arca_app"], using: sql`(EXISTS ( SELECT 1
   FROM tarea t
  WHERE ((t.id = tarea_notificacion.tarea_id) AND (t.org_id = current_setting('app.org_id'::text, true)))))` }),
]);
